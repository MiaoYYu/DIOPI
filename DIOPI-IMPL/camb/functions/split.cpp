...
extern "C" diopiError_t diopiSplitWithSizes(diopiContextHandle_t ctx, diopiTensorHandle_t* outs, int64_t numOuts, diopiConstTensorHandle_t input,
    ...
    cnnlTensorDescriptor_t* descPtrs = new cnnlTensorDescriptor_t[numOuts];
    void** dataPtrs = new void*[numOuts];
    ...
    DIOPI_CALLCNNL(cnnlSplit(handle, numOuts, dim, inputDesc.get(), inputTensor.data(), worksapce, worksapceSize, descPtrs, dataPtrs));
